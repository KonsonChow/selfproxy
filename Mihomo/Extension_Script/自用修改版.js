...
function overwriteRules (params) {
    ...
    const nonipRules = [
        ...
        "RULE-SET,stream_jp_non_ip,JP - 自动选择",
    ...
    const ruleProviders = {
        ...
        stream_jp_non_ip:{
            ...
            path: "./rule_set/sukkaw_ruleset/stream_jp_non_ip.txt",
            proxy: "🎯 节点选择"
        },
        stream_jp_ip:{
            type: "http",
            ...
            path: "./rule_set/sukkaw_ruleset/stream_jp_ip.txt",
            proxy: "🎯 节点选择"
        },
        // AIGC
        ai_non_ip: {
...
function overwriteProxyGroups (params) {
    ...
    const includeTerms = {
        HK: "(香港|港|HK|Hong|🇭🇰)",
        TW: "(台湾|台|TW|Taiwan|Wan|🇹🇼|🇨🇳)",
        SG: "(新加坡|新|狮城|SG|Singapore|🇸🇬)",
        JP: "(日本|日|JP|Japan|🇯🇵)",
        KR: "(韩国|韓|KR|Korea|🇰🇷)",
        US: "(美国|美|US|United States|America|🇺🇸)",
    ...
    const groups = [
        ...
        },
        {
            name: "🎬 日本流媒体",
            type: "select",
            proxies: ["🎯 节点选择", "HK - 自动选择", "JP - 自动选择", "KR - 自动选择", "SG - 自动选择", "US - 自动选择", "UK - 自动选择", "FR - 自动选择", "DE - 自动选择", "TW - 自动选择", "其它 - 自动选择","HK - 手动选择", "JP - 手动选择", "KR - 手动选择", "SG - 手动选择", "US - 手动选择", "UK - 手动选择", "FR - 手动选择", "DE - 手动选择", "TW - 手动选择"],
            // "include-all": true,
            icon: "https://raw.githubusercontent.com/Orz-3/mini/master/Color/Telegram.png"
        },
        {
...
function overwriteTunnel (params) {
    const tunnelOptions = {
        ...
        "strict-route": true,
        // 根据自己环境来看要排除哪些网段
        "route-exclude-address": ["100.95.171.100/24"],
    };
